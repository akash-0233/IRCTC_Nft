...
import Irctc from './components/Irctc/Irctc';
...
function App() {
  ...
  const contractAddress = "0xd4cBA300C05a087416E550eFBAcdDa0eF3D92cB3";
  ...
  //   try {
  //     const ticketof = await contractInstance.methods.tokensOf(address).call();
  //     alert(`Ticket is ${ticketof}`);
  ...
  return (
    <>
    {showComponent && <Irctc Toggle={Toggle} state={state} address={address}></Irctc>}
     {!showComponent && <Home state={state} address={address} Toggle={Toggle}></Home> } 
    </>
  )
}
